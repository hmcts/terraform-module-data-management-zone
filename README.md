...
| [azurerm_eventhub_consumer_group.eventhub_consumer_groups](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/eventhub_consumer_group) | resource |
...
| [azurerm_eventhub_namespace_network_rule_set.eventhub_network_rules](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/eventhub_namespace_network_rule_set) | resource |
...
| <a name="input_eventhub_consumer_groups"></a> [eventhub\_consumer\_groups](#input\_eventhub\_consumer\_groups) | Allows custom consumer groups to be created for eventhub namespaces | <pre>map(object({<br/>    name = string<br/>  }))</pre> | n/a | yes |
