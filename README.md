...
| <a name="input_eventhub_consumer_groups"></a> [eventhub\_consumer\_groups](#input\_eventhub\_consumer\_groups) | Allows custom authorisation rules to be created for eventhub namespaces | <pre>map(object({<br/>    name = string<br/>  }))</pre> | n/a | yes |
